...
const ShopPartnerDebtBillAcceptanceDoc = dynamic(() => import("../../routes/Sales/ShopPartnerDebtBillAcceptanceDoc"), { loading: () => <CarPreloader /> });
...
export default Page(() => (
    <React.Fragment>
        ...
        <React.Fragment>
            <Card className="mb-5">
                <ShopPartnerDebtBillAcceptanceDoc />
            </Card>
        </React.Fragment>
    </React.Fragment>
));
