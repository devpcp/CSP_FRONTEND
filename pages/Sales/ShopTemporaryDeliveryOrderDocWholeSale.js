...
const TemporaryDeliveryOrderDocWholeSale = dynamic(() => import("../../routes/Sales/ShopTemporaryDeliveryOrderDocWholeSale"), { loading: () => <CarPreloader /> });
...
export default Page(() => (
    <React.Fragment>
        ...
        <React.Fragment>
            <Card className="mb-5">
                <TemporaryDeliveryOrderDocWholeSale />
            </Card>
        </React.Fragment>
    </React.Fragment>
));
