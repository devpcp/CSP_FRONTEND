...
import ProductReturnReceiptDoc from '../../components/Routes/Inventory/ProductReturnReceiptDoc'
...
const ProductReturnReceipt = () => {
    return <ProductReturnReceiptDoc docTypeId={`dfa5a7ed-4f01-41bd-894f-cd28d1068ad0`}/>
}

export default ProductReturnReceipt