...
import TranferInventoryDoc from '../../components/Routes/Inventory/TranferInventoryDoc'
...
const TranferInventory = () => {
    return <TranferInventoryDoc docTypeId={`53e7cbcc-3443-40e5-962f-d9512aba2b5a`}/>
}

export default TranferInventory