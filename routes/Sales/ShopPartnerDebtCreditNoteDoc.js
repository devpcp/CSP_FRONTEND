...
import ShopPartnerDebtCreditNoteDoc from '../../components/Routes/Sales/ShopPartnerDebtCreditNoteDoc'
...
const ServicePlans = () => {
    return <ShopPartnerDebtCreditNoteDoc docTypeId={`812567a8-5990-41ce-95e8-d96fc4cdadcb`}/>
}
