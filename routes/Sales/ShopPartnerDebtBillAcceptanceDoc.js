...
import ShopPartnerDebtBillAcceptanceDoc from '../../components/Routes/Sales/ShopPartnerDebtBillAcceptanceDoc'
...
const ServicePlans = () => {
    return <ShopPartnerDebtBillAcceptanceDoc docTypeId={`819338e7-a907-4aaf-b3dc-83084c291dbd`}/>
}
