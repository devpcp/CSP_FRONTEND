...
import TemporaryDeliveryOrderDoc from '../../components/Routes/Sales/ShopRetailDocument/ShopTemporaryDeliveryOrderDoc'
...
const ServicePlans = () => {
    return <TemporaryDeliveryOrderDoc docTypeId={`80235edb-53e0-43ee-9b3b-768e3e2e7777`}/>
}
