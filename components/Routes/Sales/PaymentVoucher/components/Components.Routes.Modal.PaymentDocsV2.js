...
const PaymentDocsV2 = ({ docId, title, loading, handleCancelModal, initForm, carPreLoading, setCarPreLoading, fromTable = false, debtDocObj = null }) => {
    ...
    useEffect(() => {
        setTableColumns()
        // console.log(initForm.getFieldValue())
    }, [])
        ...
        try {
            ...
            _column.push(
                ...
                },
                {
                    ...
                    width: "10%",
                    align: "center",
                    render: (text, record, index) => <div style={{ textAlign: "end" }}>{RoundingNumber(record?.warehouse_detail[0]?.other_details?.price_unit) ?? "-"}</div>,
                },
                {
                    ...
                    width: "15%",
                    align: "center",
                    render: (text, record, index) => <div style={{ textAlign: "end" }}>{RoundingNumber(record?.warehouse_detail[0]?.other_details?.price_discount_total) ?? "-"}</div>,
                },
                {
                    ...
                    width: "15%",
                    align: "center",
                    render: (text, record, index) => <div style={{ textAlign: "end" }}>{RoundingNumber(record?.warehouse_detail[0]?.other_details?.price_grand_total) ?? "-"}</div>,
                },
            )
            setColumns(() => [..._column])
                                        ...
                                        <div className="detail-before-table">
                                            ...
                                            <div className="invoices-price-paid">
                                                ...
                                                <div className="invoices-text-price">
                                                    {getValue(["details", "price_grand_total"], true)} บาท
                                                </div>
                                            </div>
                                            ...
                                            <Col xl={6} lg={12} md={6} sm={12} xs={12}>
                                                <div>
                                                    <ComponentsPayWithCash
                                                        ...
                                                        total={getValue(["details", "price_grand_total"])}
