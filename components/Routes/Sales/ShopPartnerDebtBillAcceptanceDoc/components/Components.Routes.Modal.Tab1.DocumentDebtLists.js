        ...
        try {
            ...
            switch (type) {
                case "price_unit":
                    ...
                    list_service_product[index]["price_grand_total"] = price_grand_total.toFixed(2)
                    list_service_product[index]["price_unit"] = price_unit.toFixed(2)
                ...
                case "price_discount":
                    ...
                    if ((!!price_discount_percent && Number(price_discount_percent) < 0.01) || price_unit === 0) {
                        ...
                        list_service_product[index]["price_discount"] = price_discount.toFixed(2)
                        list_service_product[index]["price_discount_percent"] = price_discount_percent.toFixed(2)
                        list_service_product[index]["price_grand_total"] = price_grand_total.toFixed(2)
                    }
                ...
                default:
                    for (let i = 0; i < list_service_product.length; i++) {
                        ...
                        list_service_product[i]["price_grand_total"] = price_grand_total.toFixed(2)
                    }
                    break;
            }
