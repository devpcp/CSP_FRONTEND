                ...
                render: (text, record, index) => (
                    <>
                        <Form.Item style={{ margin: 0 }} name={[index, "price_unit"]}>
                            <InputNumber disabled={true} size="large" style={{ width: "100%" }} step="0.01" stringMode precision={2}
                        ...
                        <Row gutter={[0, 10]}>
                            ...
                            <Col span={24}>
                                <Form.Item noStyle name={[index, "purchase_unit_id"]}>
                                    <Select disabled={true} placeholder="หน่วยซื้อ" style={{ width: "100%", margin: 0, padding: 0, textAlign: "center" }} size="large" showSearch dropdownMatchSelectWidth={false}>
