...
import { PlusOutlined, DeleteOutlined, FormOutlined, CalculatorOutlined, SearchOutlined, CheckCircleFilled } from "@ant-design/icons";
...
const ComponentsRoutesModalTab1ServiceAndProductV2 = ({ onFinish, calculateResult, mode }) => {
    ...
    console.log("setting_enable_sale_price_overwrite", authUser?.UsersProfile?.ShopsProfile?.shop_config?.enable_sale_price_overwrite)
