            ...
            <Row gutter={[20]}>
                ...
                <Col lg={8} md={12} xs={24}>
                    <Form.Item label={`วันที่ติดต่อล่าสุด`}>
                        ...
                        <DatePicker placeholder='' style={{ width: "100%" }} format={"DD/MM/YYYY"} disabled value={getValue("last_service", "", true)} />
                    </Form.Item>
                </Col>
                <Col lg={8} md={12} xs={24}>
                    <Form.Item label={`วันที่ติดต่อครั้งแรก`}>
                        <DatePicker placeholder='' style={{ width: "100%" }} format={"DD/MM/YYYY"} disabled value={getValue("details", "service_date_first", true)} />
                    </Form.Item>
                </Col>
                <Col lg={8} md={12} xs={24}>
