        ...
        try {
            ...
            switch (type) {
                case "price_unit":
                    ...
                    arr_debt_list[index]["price_grand_total"] = MatchRound(price_grand_total)
                    arr_debt_list[index]["price_unit"] = MatchRound(price_unit)
                ...
                case "price_discount":
                    ...
                    if ((!!price_discount_percent && Number(price_discount_percent) < 0.01) || price_unit === 0) {
                        ...
                        arr_debt_list[index]["price_discount"] = MatchRound(price_discount)
                        arr_debt_list[index]["price_discount_percent"] = MatchRound(price_discount_percent)
                        arr_debt_list[index]["price_grand_total"] = MatchRound(price_grand_total)
                    }
                ...
                default:
                    for (let index = 0; index < arr_debt_list.length; index++) {
                        amount = Number(arr_debt_list[index]["amount"] ?? 0)
                        price_unit = Number(arr_debt_list[index]["price_unit"] ?? 0)
                        price_discount = Number(arr_debt_list[index]["price_discount"] ?? 0)
