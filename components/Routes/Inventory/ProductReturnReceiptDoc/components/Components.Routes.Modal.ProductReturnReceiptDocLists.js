...
const ComponentsRoutesModalProductReturnReceiptDocLists = ({ onFinish, calculateResult, mode }) => {
    ...
    const columns = [
        ...
        {
            title: () => GetIntlMessages("เปลี่ยนชื่อ"),
            dataIndex: 'change_name_status',
            key: '',
            width: "50px",
            align: "center",
            render: (text, record, index) => {
        ...
        {
            title: () => GetIntlMessages("เลือกคลัง"),
            dataIndex: '',
            key: '',
            width: "50px",
            align: "center",
            ...
            render: (text, record, index) => (
                <>
                    <Form.Item rules={[
                        ...
                        <InputNumber min={1} disabled={mode === "view"} stringMode style={{ width: "100%" }} formatter={(value) => !!value && value.length > 0 ? `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',') : ""}
                ...
                <Row gutter={[10, 10]}>
                    <Col lg={12} md={12} xs={24}>
                        <Row gutter={[20, 10]}>
                            ...
                            <Col span={12}>
                                <Form.Item
                                    label={GetIntlMessages("หมายเหตุภายใน")}
                                    name="remark_inside">
                                    <Input.TextArea rows={16} disabled={mode === "view"} />
                                </Form.Item>
                            </Col>
