...
const TranferInventoryDocLists = ({ onFinish, calculateResult, mode }) => {
    ...
    const columns = [
        ...
        {
            title: () => (<><span style={{ color: "red" }}>* </span>{GetIntlMessages("ต้นทุนต่อหน่วย")}</>),
            dataIndex: '',
            key: '',
            width: "10%",
            align: "center",
...
export default TranferInventoryDocLists