    ...
    const setColumnsTable = () => {
        const _column = [
            ...
            },
            {
                ...
                width: 150,
                align: "center",
                render: (text, record) => get(text, "ShopProduct.Product.master_path_code_id", "-"),
                use: true
            },
            {
                title: "ชื่อสินค้า",
                ...
                width: 300,
                use: true,
                render: (text, record) => get(text, `ShopProduct.Product.product_name.${locale.locale}`, "-"),
            },
            {
                title: "ยี่ห้อสินค้า",
                dataIndex: "",
                ...
                width: 150,
                use: true,
                render: (text, record) => get(text, `ShopProduct.Product.ProductBrand.brand_name.${locale.locale}`, "-"),
            },
            {
                title: "รุ่น",
                dataIndex: "",
                ...
                width: 150,
                use: true,
                render: (text, record) => get(text, `ShopProduct.Product.ProductModelType.model_name.${locale.locale}`, "-"),
            },
            {
                title: "คลัง",
                dataIndex: "",
                ...
                width: 100,
                use: true,
                render: (text, record) => get(text, `warehouse_name`, "-"),
            },
            {
                title: "ชั้น",
                dataIndex: "",
                ...
                width: 100,
                use: true,
                render: (text, record) => get(text, `shelf_name`, "-"),
            },
            {
                title: "DOT",
                dataIndex: "",
            ...
            },
            {
                ...
                width: 100,
                use: true,
                render: (text, record) => get(text, `purchase_unit_name`, "-"),
            },
            {
                title: "ราคาต่อหน่วย",
                dataIndex: "",
